...
export class Operation extends React.Component<IOperationProps, IOperationState> {
    ...
    render() {
        const { operationList, match } = this.props as any;
        return (
            <div>
                                        ...
                                        <tr key={`entity-${i}`}>
                                            ...
                                            <td>
                                                {operation.bankAccountName ? (
                                                    <Link
                                                        to={`bank-account/${operation.bankAccountId}`}>
                                                        {operation.bankAccountName}
                                                    </Link>
                                                ) : (
                                                    ''
                                            ...
                                            <td className="text-right">
                                                <div className="btn-group flex-btn-group-container">
                                                    ...
                                                    <Button
                                                        tag={Link}
                                                        to={`${match.url}/${operation.id}/edit`}
                                                        color="primary"
                                                        size="sm">
                                                    ...
                                                    <Button
                                                        tag={Link}
                                                        to={`${match.url}/${operation.id}/delete`}
                                                        color="danger"
                                                        size="sm">
