...
import { getEntities as getOperations } from '../../entities/operation/operation.reducer';
import { getEntity, updateEntity, createEntity, reset } from './label.reducer';

export interface ILabelUpdateProps
    extends StateProps,
        DispatchProps,
...
export class LabelUpdate extends React.Component<ILabelUpdateProps, ILabelUpdateState> {
    ...
    render() {
        const { labelEntity, loading, updating } = this.props as any;
