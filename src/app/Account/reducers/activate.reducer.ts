...
// Selectors
const getActivateState = (state: IRootState) => state.account.activate;

export const selectActivationSuccess = createSelector(
    getActivateState,
    (state: ActivateState) => state.activationSuccess
);

export const selectActivationFailure = createSelector(
    getActivateState,
    (state: ActivateState) => state.activationFailure
);
