...
export class LogsPage extends React.Component<ILogsPageProps, ILogsPageState> {
    ...
    render() {
        const { logs, isFetching } = this.props as any;
                ...
                <table className="table table-sm table-striped table-bordered">
                    <thead>
                        <tr title="click to order">
                            <th>
                                <span>
                                    <Translate contentKey="logs.table.name">
                                        Name
                                    </Translate>
                                </span>
                            </th>
                            <th>
                                <span>
                                    <Translate contentKey="logs.table.level">
                                        Level
                                    </Translate>
                                </span>
                            </th>
...
export default connect(mapStateToProps, mapDispatchToProps)(LogsPage as any);
