...
export interface IOperationDetailProps
    extends StateProps,
        DispatchProps,
            ...
            <Row>
                <Col md="8">
                    ...
                    <dl className="jh-entity-details">
                        ...
                        <dd>
                            {operationEntity.bankAccountName ? (
                                operationEntity.bankAccountName
                            ) : (
                                ''
                            )}
                        ...
                        <dd>
                            {operationEntity.labels ? (
                                operationEntity.labels.map((val: any, i) => (
                                    <span key={val.id}>
                                        <span className="text-primary">{val.label}</span>
                    ...
                    <Button
                        tag={Link}
                        to={`/entity/operation/${operationEntity.id}/edit`}
                        replace
                        color="primary">
