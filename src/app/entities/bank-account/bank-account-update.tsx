...
export class BankAccountUpdate extends React.Component<
    IBankAccountUpdateProps,
    IBankAccountUpdateState
> {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        const { bankAccountEntity, users, loading, updating } = this.props as any;
