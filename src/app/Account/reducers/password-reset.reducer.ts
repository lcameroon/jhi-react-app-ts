...
// Selectors
const getPasswordResetState = (state: IRootState) => state.account.passwordReset;
...
export const selectResetPasswordSuccess = createSelector(
    getPasswordResetState,
    (state: PasswordResetState) => state.resetPasswordSuccess
);

export const selectResetPasswordFailure = createSelector(
    getPasswordResetState,
    (state: PasswordResetState) => state.resetPasswordFailure
);
